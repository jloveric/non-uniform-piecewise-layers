...
def test_add_point_at_max_error():
    ...
    for strategy in range(3):
        ...
        success = layer.add_point_at_max_error(split_strategy=strategy)
        assert success
        assert layer.num_points == 3
...
def test_add_point_gpu():
    ...
    # Add point
    success = layer.add_point_at_max_error(split_strategy=0)
    assert success
    assert layer.num_points == 3
...
def test_multiple_dimensions():
    ...
    success = layer.add_point_at_max_error()
    assert success
    assert layer.num_points == 3
