...
class AdaptiveConvNet(nn.Module):
    def __init__(self, num_points=3):
        ...
        self.conv1 = AdaptivePiecewiseConv2d(3, 32, kernel_size=3, num_points=num_points)
        self.pool1 = nn.MaxPool2d(2)
        
        # Second convolutional layer: 32 input channels, 64 output channels
        self.conv2 = AdaptivePiecewiseConv2d(32, 64, kernel_size=3, num_points=num_points)
        self.pool2 = nn.MaxPool2d(2)
        
        # Third convolutional layer: 64 input channels, 128 output channels
        self.conv3 = AdaptivePiecewiseConv2d(64, 128, kernel_size=3, num_points=num_points)
    ...
    def move_smoothest(self, weighted:bool=True):
        ...
        with torch.no_grad():
            ...
            success = success & self.conv3.move_smoothest(weighted=weighted)
        return success
...
@hydra.main(version_base=None, config_path="config", config_name="cifar100_classification")
